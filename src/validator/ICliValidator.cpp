...
namespace EasySoft
{
    namespace Cli
    {
        bool ICliValidator :: Validate(const std::vector<EasySoft::Cli::Option>& options, const bool useWithoutOptions, const bool printHelp) const
        {
            ...
            std::find_if(options.begin(), options.end(),[&helpPresent](EasySoft::Cli::Option option)
                                                        {
            ...
            std::find_if(options.begin(), options.end(),[&versionPresent](EasySoft::Cli::Option option)
                                                        {
